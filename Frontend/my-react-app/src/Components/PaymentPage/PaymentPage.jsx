...
const PaymentPage = () => {
  ...
  useEffect(() => {
    ...
    const checkRazorpay = () => {
      ...
      if (retryCount < maxRetries) {
        ...
        alert(
          "⚠️ Payment gateway failed to load. Please check your internet connection and refresh the page."
        );
      }
    };
    checkRazorpay();
  ...
  const initiatePayment = () => {
    ...
    if (amountInPaise < 100) {
      alert(
        "⚠️ Minimum order amount is ₹1. Please add more items to your cart."
      );
      setLoading(false);
      return;
    }
    ...
    const options = {
      ...
      image:
        "https://assets.myntassets.com/assets/images/retaillabs/2019/2/20/9f612eb6-1871-410c-b126-3141630c08d51550685418928-myntra.png",
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "30px", textAlign: "center" }}>
          <h1 style={{ color: "#ff3f6c", marginBottom: "10px" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ color: "#ff3f6c", fontSize: "18px" }}>
